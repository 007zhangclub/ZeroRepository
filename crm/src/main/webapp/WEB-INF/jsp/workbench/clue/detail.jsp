...
<body>
	...
	<input type="hidden" id="hidden-fullname" value="${clue.fullname}">
	<input type="hidden" id="hidden-compney" value="${clue.company}">
	<input type="hidden" id="hidden-appellation" value="${clue.appellation}">
